...
// 1. Declaramos el mock de nuestro repositorio con todos sus métodos
...
describe('SportController Integration Tests', () => {
    let app: FastifyInstance;

    // Cuerpo base válido compartido como molde para las pruebas
    ...
    /* ==========================================================================
       SUITE: ALTA DE DEPORTES (POST)
       ========================================================================== */
    describe('POST /api/v1/sports - Alta', () => {
        ...
        it('2. devuelve 409 cuando el nombre del deporte ya existe', async () => {
            // Simulamos que al buscar por nombre SÍ encuentra un deporte ya registrado
    ...
    /* ==========================================================================
       SUITE: ACTUALIZACIÓN DE DEPORTES (PUT)
       ========================================================================== */
    describe('PUT /api/v1/sports/:id - Actualización', () => {

        it('1. devuelve 200 y actualiza el deporte exitosamente', async () => {
        ...
        it('2. devuelve 404 cuando se intenta actualizar un deporte que no existe', async () => {
